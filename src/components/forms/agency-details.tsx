...
const AgencyDetails: React.FC<Props> = ({data}) => {
    ...
    const handleSubmit =async (values: z.infer<typeof FormSchema>) => {
        ...
        try {
            let newUserData
            let custId
            console.log('handle submit data.id', data?.id)
            if (!data?.id) {
                const bodyData = {
        ...
        <AlertDialog>
            <Card className = 'w-full'>
                <CardHeader>
                    ...
                    <CardDescription> 
                        Lets create and agency for your business. You can edit agency settings later from the agency settings tab.
                    </CardDescription>
                </CardHeader>
                <CardContent>  
                <Form {...form}>
